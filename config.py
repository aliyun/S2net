# --------------------------------------------------------
# We adopt this configuration method like swin-transfomer(https://github.com/microsoft/Swin-Transformer.git)
# --------------------------------------------------------'
...
def update_cfg_from_file(config, cfg_file):
    ...
    for cfg in yaml_cfg.setdefault('BASE', ['']):
        if cfg:
            update_cfg_from_file(config, os.path.join(os.path.dirname(cfg_file), cfg))
